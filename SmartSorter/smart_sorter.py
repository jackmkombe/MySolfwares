...
====================================================
Version 3.0 - Interface Moderne avec CustomTkinter

Auteur: Ingénieur Python Senior
Version: 3.0.0 (Ultra Modern UI)
"""
...
class SmartSorter(ctk.CTk):
    ...
    def _setup_ui(self):
        ...
        self._bind_mousewheel(scroll_frame)
    ...
    def _bind_mousewheel(self, widget):
        """Active le défilement avec la molette de la souris."""
    ...
    def _create_source_section(self, parent):
        """Section de sélection du dossier source."""
        content = self._create_card(parent, "📁 Dossier Source")
        
        # Frame pour le champ et le bouton
    ...
    def _create_sort_type_section(self, parent):
        """Section de sélection du type de tri."""
    ...
    def _create_ignore_section(self, parent):
        """Section des règles d'ignorance."""
        ...
        if self.ignore_patterns:
            ...
            patterns_label.pack(anchor="w", pady=(15, 5))
    ...
    def _create_destination_section(self, parent):
        ...
        # Checkbox pour destination personnalisée
        custom_dest_check = ctk.CTkCheckBox(
            content,
        ...
        custom_dest_check.pack(anchor="w", pady=(0, 10))
        
        # Frame pour la destination (caché par défaut)
    ...
    def _create_action_button(self, parent):
        ...
        preview_btn.pack(side="left", fill="x", expand=True, padx=(0, 10))
        ...
        self.action_btn.pack(side="right", fill="x", expand=True)
    ...
    def _on_sort_type_change(self):
        ...
        if self.sort_type.get() == "folders":
            ...
            self._create_file_types_section(self.file_types_frame.master)
            
    def _toggle_destination(self):
        """Active/désactive la destination personnalisée."""
    ...
    def _update_similarity_label(self, value):
        """Met à jour le label de similarité."""
        self.similarity_label.configure(text=f"{float(value):.2f}")
        
    def _add_pattern(self):
        """Ajoute un motif d'ignorance."""
    ...
    def _update_patterns_display(self):
        """Met à jour l'affichage des motifs."""
        if hasattr(self, 'patterns_display'):
            self.patterns_display.delete("1.0", "end")
            self.patterns_display.insert("1.0", ", ".join(self.ignore_patterns))
            
    # === LOGIQUE DE TRI ===
    
    def _clean_name(self, name: str) -> str:
        """Nettoie un nom selon les règles d'ignorance."""
        cleaned = name
    ...
    def _get_items_to_process(self) -> List[Path]:
        """Récupère les éléments à traiter."""
    ...
    def _preview(self):
        ...
        try:
            ...
            for group_name, group_items in list(groups.items())[:5]:  # Limiter à 5 groupes
